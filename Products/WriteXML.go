...
func writeXML(xmlData []byte) {
	...
	if gridFile, errFile := gridFS.Create(`Products.xml`); errFile != nil {
		...
		Log.LogShort(senderName, LM.CategoryAPP, LM.LevelINFO, LM.MessageNameINPUT, `The new product catalog was saved.`)
	}
}
